...
const About = ({ theme }) => {
  return (
    <div id="about" className="h-[100vh] flex  items-center gap-16 flex-col lg:flex-row lg:justify-between pt-8 ">
      <div id="about" className="w-full lg:w-5/8 order-2 flex flex-col gap-8 pl-8 lg:order-1">
        <div id="title" className="text-2xl font-bold lg:text-3xl xl:text-5xl">
          Hi, I am <span style={{ color: theme.highLighter }}>Ritesh Kumar.</span>
        </div>
        <div id="about_me" className=" text-xl lg:text-2xl">
      ...
      <div id="profilePic" className="w-full order-1 lg:w-3/8 flex items-center justify-center lg:order-2">
