...
export const projects = [
  ...
  },
  {
    pic: ChatZone,
    name: "ChatZone",
    description: "ChatZone, an advanced chat application using React for the frontend and NodeJS, Express, and MongoDB for the backend. Integrated Socket.io for seamless realtime communication, ensuring instant messaging capabilities. Leveraged cutting-edge technologies and best practices for a highly functional and user friendly chat experience.",
  ...
  },
  {
    pic: PDAnalyzer,
    name: "PDAnalyzer",
    description: "PDAnalyzer is a Python project dedicated to Parkinson's Disease detection through an insightful exploration of ten machine learning algorithms. Leveraging scikitLearn and XGBoost, this project emphasizes the significance of meticulous model selection, offering valuable insights for the advancement of Parkinson's Disease diagnosis and treatment research.",
  ...
  },
  {
    pic: Drumkit,
    name: "Drumkit",
    description: "Drumkit is an interactive online platform for creating music through keystrokes or mouse clicks. With a user friendly interface, users can effortlessly explore different sounds and create rhythms with a virtual drum kit. Whether using a keyboard or mouse, Drumkit offers an immersive experience to unleash musical creativity.",
    link: "https://ritesh560.github.io/drum_kit/",
    github: "https://github.com/Ritesh560/drum_kit",
  },
]
